...
/*   Updated: 2022/09/20 12:11:19 by mbascuna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm *ShrubberyCreationForm::make(std::string formTarget)
{
	ShrubberyCreationForm *a = new ShrubberyCreationForm(formTarget);
	return a;
}
