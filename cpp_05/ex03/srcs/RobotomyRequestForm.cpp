...
/*   Updated: 2022/09/20 12:11:37 by mbascuna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm *RobotomyRequestForm::make(std::string formTarget)
{
	RobotomyRequestForm *a = new RobotomyRequestForm(formTarget);
	return a;
}
